              ...
              if (ResponsiveBreakpoints.of(context).smallerOrEqualTo(TABLET))
                PopupMenuButton<int>(
                  ...
                  itemBuilder: (context) => [
                    PopupMenuItem(
                      value: 0,
                      child: Text('LandingPage.home'.tr()),
                    ),
                    PopupMenuItem(
                      value: 1,
                      child: Text('LandingPage.about'.tr()),
                    ),
                    PopupMenuItem(
                      value: 2,
                      child: Text('LandingPage.services'.tr()),
                    ),
                    PopupMenuItem(
                      value: 3,
                      child: Text('LandingPage.contact'.tr()),
                    ),
                    // const PopupMenuItem(
                    //   value: 4,
                    //   child: Text('Download'),
                    ...
                    PopupMenuItem(
                      value: 5,
                      child: Text('LandingPage.signIn'.tr()),
                    ),
                  ],
                )
              else
