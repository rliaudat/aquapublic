...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  goAuth() {
    ...
    if (identifier.text.isEmpty) {
      showToast(context,
          msg: 'ForgotPasswordScreen.pleaseEnterValidEmailOrPhoneNumber'.tr());
    } else {
  ...
  checkEmail() async {
    BlocProvider.of<AuthenticationBloc>(context)
        .add(SendForgotPasswordLink(email: identifier.text));
  }
  ...
  checkPhone() async {
    ...
    firestore
      ...
      if (value.docs.isNotEmpty) {
        ...
        showToast(context,
            msg: 'ForgotPasswordScreen.pleaseEnterValidCredentials'.tr());
      }
    });
  }
    ...
    return GestureDetector(
      ...
      child: BlocListener<AuthenticationBloc, AuthenticationState>(
        listener: (context, state) {
          if (state is SendingForgotPasswordLink) {
            showLoader(context, 'ForgotPasswordScreen.justAMoment'.tr());
          }
          if (state is ForgotPasswordLinkSended) {
            Navigator.pop(context);
            showToast(
              context,
              msg: 'ForgotPasswordScreen.passwordResetLinkSent'.tr(),
              duration: 4,
            );
          }
                              ...
                              children: [
                                ...
                                Column(
                                  children: [
                                    ...
                                    Text(
                                      'ForgotPasswordScreen.enterYourEmailToSendOtp'
                                          .tr(),
                                ...
                                TextField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText:
                                        'ForgotPasswordScreen.enterYourEmailOrPhoneNumber'
                                            .tr(),
                                    prefixIcon:
