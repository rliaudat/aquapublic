          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    'UserFilterBottomSheet.filter'.tr(),
              ...
              CompositedTransformTarget(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'UserFilterBottomSheet.enterTownId'.tr(),
                    prefixIcon: Icon(
                      Icons.home_work,
                      color: borderColor,
                      size: 20,
              ...
              SizedBox(height: p),
              Text(
                'UserFilterBottomSheet.house'.tr(),
                style: const TextStyle(
                  fontWeight: FontWeight.bold,
                ),
              ),
              ...
              TextField(
                decoration: InputDecoration(
                  hintText: 'UserFilterBottomSheet.enterHouseId'.tr(),
                  hintStyle: TextStyle(
                    color: blackColor,
                    fontSize: 12,
                  ),
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                          'UserFilterBottomSheet.inspector'.tr(),
                          style: TextStyle(
                            color: !isSelected ? whiteColor : blackColor,
                ...
                children: [
                  Expanded(
                    child: Button(
                      borderRadius: 12,
                      height: 45,
                      text: 'UserFilterBottomSheet.apply'.tr(),
                  ...
                  Expanded(
                    child: Button(
                      borderRadius: 12,
                      height: 45,
                      text: 'UserFilterBottomSheet.reset'.tr(),
                      onPressed: () => Navigator.pop(context),
                    ),
                  ),
                ],
