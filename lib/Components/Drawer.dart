...
import 'package:agua_med/views/User/privacy&policy.dart';
import 'package:agua_med/views/User/terms&Conditions.dart';
        ...
        child: Column(
          children: [
            ...
            UserAccountsDrawerHeader(
              accountName: Text(
                '${userSD['firstName'] ?? ''} ${userSD['lastName'] ?? ''}',
                style: const TextStyle(
                  fontWeight: FontWeight.bold,
                ),
              ),
              accountEmail: Text(userSD['email'] ?? ''),
            ...
            DrawerTiles(
              ...
              onTap: () {
                ...
                if (userSD['role'] == 'Admin') {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const AdminHomeScreen())).then((value) {
                    if (mounted) setState(() => selectedTile = 0);
                  });
                } else if (userSD['role'] == 'Manager') {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const ManagerHomeScreen())).then((value) {
                    if (mounted) setState(() => selectedTile = 0);
                  });
                } else if (userSD['role'] == 'Inspector') {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const InspectorHomeScreen())).then((value) {
                    if (mounted) setState(() => selectedTile = 0);
                  });
                } else {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const HomeScreen())).then((value) {
                    if (mounted) setState(() => selectedTile = 0);
                  });
                }
              },
              ...
              rowWidth: isTablet ? width(context) * 0.021 : width(context) * 0.05,
              size: 18,
            ),

            if (userSD['role'] == 'Admin' || userSD['role'] == 'Manager')
              DrawerTiles(
                text: 'CustomDrawer.houseOwners'.tr(),
                onTap: () {
                  if (mounted) setState(() => selectedTile = 1);
                  pop(context);
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const AllUsersScreen(header: 'House Owner', role: 'HouseOwner'))).then((value) {
                    if (mounted) setState(() => selectedTile = 1);
                  });
                },
            ...
            if (userSD['role'] == 'Admin' || userSD['role'] == 'Manager')
              DrawerTiles(
                ...
                onTap: () {
                  ...
                  pop(context);
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const AllUsersScreen(header: 'Inspector', role: 'Inspector'))).then((value) {
                    if (mounted) setState(() => selectedTile = 2);
                  });
                },
                imagePath: 'assets/images/inspector.png',
                rowWidth: isTablet ? width(context) * 0.017 : width(context) * 0.041,
                size: 22,
            ...
            if (userSD['role'] == 'Admin' || userSD['role'] == 'Manager')
              DrawerTiles(
                ...
                onTap: () {
                  ...
                  pop(context);
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const UserRegistrationScreen())).then((value) {
                    if (mounted) setState(() => selectedTile = 3);
                  });
                },
                imagePath: 'assets/images/registeration.png',
                rowWidth: isTablet ? width(context) * 0.018 : width(context) * 0.04,
                size: 22,
            ...
            if (userSD['role'] == 'Admin')
              DrawerTiles(
                ...
                onTap: () {
                  ...
                  pop(context);
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const TownsScreen())).then((value) {
                    if (mounted) setState(() => selectedTile = 4);
                  });
                },
            ...
            if (userSD['role'] == 'Admin')
              DrawerTiles(
                ...
                onTap: () {
                  ...
                  pop(context);
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const AllUsersScreen(header: 'Town Manager', role: 'Manager'))).then((value) {
                    if (mounted) setState(() => selectedTile = 5);
                  });
                },
                imagePath: 'assets/images/management.png',
                rowWidth: isTablet ? width(context) * 0.0185 : width(context) * 0.039,
                size: 22,
            ...
            DrawerTiles(
              ...
              onTap: () {
                ...
                pop(context);
                if (userSD['role'] == 'Admin' || userSD['role'] == 'Manager') {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const InvoiceScreen())).then((value) {
                    if (mounted) setState(() => selectedTile = 6);
                  });
                } else {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const SearchHouseScreen())).then((value) {
                    if (mounted) setState(() => selectedTile = 6);
                  });
                }
              },
              imagePath: 'assets/images/invoice.png',
              rowWidth: isTablet ? width(context) * 0.02 : width(context) * 0.05,
              size: 20,
            ...
            DrawerTiles(
              ...
              onTap: () {
                ...
                pop(context);
                Navigator.push(context, MaterialPageRoute(builder: (context) => const EditProfileScreen())).then((value) {
                  if (mounted) setState(() => selectedTile = 7);
                });
              },
              icon: Icons.edit,
              rowWidth: isTablet ? width(context) * 0.02 : width(context) * 0.047,
              size: 20,
            ...
            if (!kIsWeb)
              DrawerTiles(
                ...
                rowWidth: isTablet ? width(context) * 0.017 : width(context) * 0.038,
                size: 22,
            ...
            DrawerTiles(
              ...
              onTap: () {
                ...
                pop(context);
                Navigator.push(context, MaterialPageRoute(builder: (context) => const PrivacyAndPolicyScreen())).then((value) {
                  if (mounted) setState(() => selectedTile = 9);
                });
              },
              icon: Icons.privacy_tip,
              rowWidth: isTablet ? width(context) * 0.017 : width(context) * 0.036,
              size: 20,
              padding: 2,
            ...
            DrawerTiles(
              ...
              onTap: () {
                ...
                pop(context);
                Navigator.push(context, MaterialPageRoute(builder: (context) => const TermsAndConditionScreen())).then((value) {
                  if (mounted) setState(() => selectedTile = 10);
                });
              },
              imagePath: 'assets/images/terms.png',
              rowWidth: isTablet ? width(context) * 0.015 : width(context) * 0.027,
              size: 22,
              padding: 3,
            ...
            DrawerTiles(
              ...
              rowWidth: isTablet ? width(context) * 0.015 : width(context) * 0.029,
              size: 22,
              padding: 3,
              selected: false,
            ),
